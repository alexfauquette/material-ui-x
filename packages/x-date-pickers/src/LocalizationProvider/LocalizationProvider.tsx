...
export interface LocalizationProviderProps<TDate extends PickerValidDate, TLocale> {
   ...
   * @see See the localization provider {@link /x/react-date-pickers/getting-started/#setup-your-date-library-adapter date adapter setup section} for more details.
   */
